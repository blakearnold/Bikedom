...
<div class="mapform_start">
	Start Date: <input id="startdate" size="10" maxlength="10" name="startdate" type="text"><img src="calendar.gif" onclick="showChooser(this, 'startdate', 'chooserSpan3', 2010, 2011, Date.patterns.ShortDatePattern, false);"> 
...
<div class="mapform_end">
	End Date: <input id="enddate" size="10" maxlength="10" name="enddate" id="enddate" type="text"><img src="calendar.gif" onclick="showChooser(this, 'enddate', 'chooserSpan2', 2010, 2011, Date.patterns.ShortDatePattern, false);"> 
	<div id="chooserSpan2" class="dateChooser select-free" style="display: none; visibility: hidden; width: 160px;"></div>
</div>
<div id="endtime">
	End time<select name="endtimehour" id="enttimehour"><?php print_timeselecthour() ?>:<select name="endtimeminute" id = "endtimeminute"><?php print_timeselectminute() ?>
</div>
<div>
